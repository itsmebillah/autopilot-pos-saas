    ...
    <div className="min-h-screen bg-black text-white flex flex-col lg:flex-row">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-white/10">
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight">Business Reports</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          ...
          <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-2xl hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs sm:text-sm font-medium text-gray-400">Today Sales</span>
            ...
            <p className="text-xs text-gray-500 mt-2">Sales recorded today</p>
          </div>

          {/* Card 2: Monthly Sales */}
          <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-2xl hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs sm:text-sm font-medium text-gray-400">Monthly Sales</span>
            ...
            <p className="text-xs text-gray-500 mt-2">Gross revenue this month</p>
          </div>

          {/* Card 3: Total Profit */}
          <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-2xl hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs sm:text-sm font-medium text-gray-400">Estimated Profit</span>
              <div className="p-2 rounded-xl bg-purple-500/20 text-purple-400">
                <DollarSign size={18} />
              </div>
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold mt-4 tracking-tight text-purple-300">
              {isLoading ? "..." : `৳ ${stats.totalProfit.toLocaleString()}`}
            </h2>
            <p className="text-xs text-gray-500 mt-2">Cumulative net margin</p>
          </div>
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 p-5 sm:p-6 rounded-2xl hover:border-amber-500/50 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs sm:text-sm font-medium text-amber-300">Low Stock Items</span>
            ...
            <p className="text-xs text-amber-400/80 mt-2">Items requiring restock</p>
          </div>
        </div>
      </main>
    </div>
